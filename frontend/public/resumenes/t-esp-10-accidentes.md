...
```mermaid
graph TD
    O["<b>O</b>bservación"] --> A["<b>A</b>lerta"]
    A --> C["<b>C</b>omunicación"]
    C --> E["<b>E</b>scape (Ruta)"]
    E --> L["<b>L</b>ugar Seguro"]
...
```mermaid
graph TD
    Start(("Inconsciente e non respira")) --> Check["Verificar Seguridade (PAS)"]
    Check --> Call["Pedir axuda (112)"]
    Call --> RCP["RCP 30 Compresións"]
    RCP --> Breath["2 Insuflacións"]
    Breath --> RCP
    Note["Ritmo: 100-120 lpm<br/>Profundidade: 5-6 cm<br/>Previo: Técnica VOS"]
```
...
```mermaid
graph LR
    P["Pinzas punta fina"] --> G["Suxeitar pola cabeza/boca"]
    G --> T["Tracción lenta e constante"]
    T --> Perp["Sempre perpendicular á pel"]
    Perp --> D["Desinfectar"]
```
